...
func expectDatabaseScenario(mock sqlmock.Sqlmock) {
...
func TestManager_RegisterContext(t *testing.T) {
	...
	suite := godog.TestSuite{
		...
		Options: &godog.Options{
			Format:    "pretty",
			Output:    buf,
			Paths:     []string{"_testdata/Database.feature", "_testdata/DatabaseTransposed.feature"},
			Strict:    true,
			Randomize: 0,
		},
	}
